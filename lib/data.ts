...
export type PracticeStage = { number: string; name: string; goal: string };
...
export const practiceStages: PracticeStage[] = content.practiceStages;
export const practiceExercises: PracticeExercise[] = content.practiceExercises;

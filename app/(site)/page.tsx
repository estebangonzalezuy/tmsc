...
export default function Home() {
  const latestPosts = archive[0].posts.concat(archive[1].posts).slice(0, 5);

  return (
    <>
      {/* Hero */}
      <section className="relative overflow-hidden px-5 md:px-6 py-24 md:py-36 text-center">
        ...
        <div className="relative">
          ...
          <h1 className="mt-8 font-serif text-4xl md:text-7xl leading-tight max-w-4xl mx-auto">
            But the brain wasn&apos;t built to create{" "}
            <em>in a vacuum</em> for years on end.
          </h1>
      ...
      <LetterMarquee text="THE MOTION SOCIAL CLUB " />
      ...
      {/* Pillars */}
      <section className="border-t border-line px-5 md:px-6 py-24 md:py-32">
        <SectionHeading
      ...
      <section className="border-t border-line grid md:grid-cols-2">
        <div className="px-5 md:px-6 py-24 md:border-r border-line">
          <SectionHeading
            label="Learn"
            title={
              <>
        ...
        <div className="px-5 md:px-6 py-24 border-t md:border-t-0 border-line">
          <SectionHeading
            label="Resources"
            title={
              <>
      ...
      {/* Human + Motion band */}
      <section className="relative overflow-hidden border-t border-line px-5 md:px-6 py-32 text-center">
        <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
          <OrbitRing
